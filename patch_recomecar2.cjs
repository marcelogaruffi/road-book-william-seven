...
const anchorStr = "<ArrowLeft className=\"size-5\" />\n        </Button>";

const newButtons = `<ArrowLeft className="size-5" />
        </Button>
...
if (normCode.includes(anchorStr)) {
  code = normCode.replace(anchorStr, newButtons);
