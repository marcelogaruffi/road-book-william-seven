...
async function run() {
  const sql = fs.readFileSync('C:\\Users\\Marcelo Garuffi\\.gemini\\antigravity\\brain\\393185b3-10c1-4699-a3b8-6972cbf70499\\vendas_tables.sql', 'utf8');
  
  // Try using postgres direct or just try to see if there is an exec_sql RPC
