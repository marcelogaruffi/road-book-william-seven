            ...
            <div className="space-y-4 mt-6">
              ...
              <div className="bg-white border border-slate-200 rounded-xl p-5 shadow-sm space-y-4 relative overflow-hidden">
                ...
                <div className="pl-2 space-y-3">
                  ...
                  {(r.hotel_cafe_inicio || r.hotel_cafe_fim || r.hotel_wifi || r.hotel_observacoes) && (
                    <div className="pt-3 mt-3 border-t border-slate-300 space-y-2 text-slate-900">
                      {(r.hotel_cafe_inicio || r.hotel_cafe_fim) && (
                        <div className="flex items-center gap-2 text-sm">
                          <span className="font-bold text-slate-900">Café da manhã:</span>
                      ...
                      {r.hotel_wifi && (
                        <div className="flex flex-col text-sm">
                          ...
                          <span className="whitespace-pre-wrap font-medium text-slate-800">{r.hotel_wifi}</span>
                        </div>
                      )}
                      {r.hotel_observacoes && (
                        <div className="flex flex-col text-sm">
                          <span className="font-bold text-slate-900">Observações:</span>
                          <span className="whitespace-pre-wrap font-medium text-slate-800">{r.hotel_observacoes}</span>
                        </div>
                      )}
                    </div>
                  )}
